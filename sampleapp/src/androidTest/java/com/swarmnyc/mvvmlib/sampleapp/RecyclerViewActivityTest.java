...
public class RecyclerViewActivityTest {
    ...
    public void recyclerViewActivityTest() {
        ...
        ViewInteraction viewGroup = onView(
                allOf(withId(R.id.layout_swipe),
                        childAtPosition(
                                childAtPosition(
        ...
        OnDeviceScreenshotAction.perform(viewGroup.toString());
        ...
        ViewInteraction imageView = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        OnDeviceScreenshotAction.perform(imageView.toString());
        imageView.check(matches(isDisplayed()));

        pressBack();
        OnDeviceScreenshotAction.perform("finished");
